...
export default function CartProduct({props}) {
  ...
  function deleteItem() {
    deleteCart(props._id)
      console.log(props._id)
      .then((res)=>{
        Swal.fire({
          html: `<p style='font-size:16px'>Remover ${props.name} do carrinho?</p>`,
          width: "fit-content",
          ...
          if (result.isConfirmed) {
            Swal.fire("Deletado!", "Seu pedido foi retirado do carrinho.", "sucesso");
          }
        });
  ...
  return (
    <Container>
      ...
      <HiOutlineTrash className="trash" onClick={()=>{
        deleteItem( )
      }} />
    </Container>
  );
